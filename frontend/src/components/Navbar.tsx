...
export default function Navbar({currentPage, onToggleSidebar, view, toggleView}: NavbarProps) {
		return (
				<header
						...
						<div className={`flex flex-row-reverse items-center relative right-4`}>
								...
								<div className={`flex flex-row`}>
										<button className={"w-8 h-8 flex items-center justify-center "} onClick={toggleView}>
